...
const groups = [
  ...
  expandedGroup('Samarkand'), expandedGroup('Namangan'), expandedGroup('Andijan'), expandedGroup('Fergana'), expandedGroup('Bukhara'), expandedGroup('Qarshi'), expandedGroup('Nukus'), expandedGroup('Urgench'), expandedGroup('Jizzakh'), expandedGroup('Navoiy'), expandedGroup('Termez'),
];
