...
test('the complete Tashkent city slice passes catalog invariants', () => {
  ...
  // The city itself is the only parent intentionally owned one level above
  // this city-local aggregate. All nested streets/addresses/areas must resolve
  // to another Tashkent entity in the slice.
