...
const expected = Object.freeze([
  ...
  ['uz:tashkent:residential:yangi-shahar', 'residential_complex', 'uz:tashkent', 'UZ'],
  ['uz:tashkent:residential:yashnabod', 'residential_complex', 'uz:tashkent:yashnobod', 'UZ'],
  ['uz:tashkent:residential:turkiston', 'residential_complex', 'uz:tashkent', 'UZ'],
...
test('catalog enrichment exposes representative canonical geo entities', () => {
...
test('catalog does not duplicate known Chernihiv Masany as a residential complex', () => {
...
test('Odesa catalog does not force surrounding settlements into city residential scope', () => {
...
test('Kyiv catalog keeps surrounding settlements outside city residential scope', () => {
...
test('Tashkent catalog excludes unnamed and unstable identities', () => {
