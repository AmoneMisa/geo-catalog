...
// Snapshot of the city-route refs published by Tashtrans after route 79 was
// added on 2026-08-18. Tashtrans is an independent reference source, so these
// records are intentionally marked manual rather than official.
...
export const TASHKENT_BUS_ROUTES = Object.freeze(
  TASHKENT_BUS_ROUTE_REFS_2026_08_18.map((ref) => ref === '79' ? route79 : metadataRoute(ref)),
);
