...
export const GEO_COVERAGE_GAPS = Object.freeze([
  ...gaps('UZ', 'Tashkent', 'local_area', ['Oltinkul','Stroygorod','Al-Khorezmi-1','Rakatboshi','Karasu-6','Chorsu'], 'No verified standalone spatial locality match yet.'),
  ...gaps('UZ', 'Tashkent', 'microdistrict', ['TTZ-3','Sputnik'], 'Verified residential-massif semantics; no verified standalone spatial object for the whole microdistrict yet.'),
