...
export const GEO_COVERAGE_GAPS = Object.freeze([
  ...
  ...gaps('UZ', 'Samarkand', 'poi', ['Samarkand City','Youth Park','Yangi Ozbekiston Park','Siab Bazaar','University Boulevard','Alisher Navoiy Park'], 'Transition gaps remain until parsing-lexicon#74 semantic normalization reaches master; Youth Park and Yangi Ozbekiston Park still need verified spatial matches.'),
  ...
  ...gaps('UZ', 'Bukhara', 'local_area', ['Center','Gijduvon Road','Gazli Road','Railway Station area','Bukhara-1','Bukhara-2','University area','Namozgoh','Sharq'], 'Lexicon local area still needs a verified standalone spatial match.'),
