...
export const UZ_TAIL_COVERAGE_GAPS = Object.freeze([
  ...
  ...gaps('Yangiyer', 'local_area', ['Center'], 'Yangiyer local-area alias still needs a verified standalone spatial match.'),
  ...
  ...gaps('Kungrad', 'local_area', ['Center','Ustyurt direction','Muynak direction'], 'Kungrad local-area alias still needs a verified standalone spatial match.'),
