...
export const UZ_TAIL_COVERAGE_GAPS = Object.freeze([
  ...
  ...gaps('Kattakurgan', 'local_area', ['Old City','Bazaar'], 'Kattakurgan local-area alias still needs a verified standalone spatial match.'),
  ...
  ...gaps('Urgut', 'local_area', ['Navoiy','Samarkand direction'], 'Urgut local-area alias still needs a verified standalone spatial match.'),
  ...gaps('Yangiyol', 'local_area', ['Samarkand Highway','Tashkent direction'], 'Yangiyol local-area alias still needs a verified standalone spatial match.'),
  ...
  ...gaps('Shirin', 'local_area', ['Energetik','Farhod','Syrdarya'], 'Shirin local-area alias still needs a verified standalone spatial match.'),
  ...gaps('Shirin', 'poi', ['HPP'], 'Shirin landmark still needs a verified spatial match.'),
  ...gaps('Gazalkent', 'local_area', ['Charvak direction','Bostanlyk direction'], 'Gazalkent local-area alias still needs a verified standalone spatial match.'),
  ...
  ...gaps('Beruniy', 'local_area', ['Turtkul Road'], 'Beruniy local-area alias still needs a verified standalone spatial match.'),
  ...gaps('Turtkul', 'local_area', ['Bazaar'], 'Turtkul local-area alias still needs a verified standalone spatial match.'),
  ...gaps('Shahrixon', 'local_area', ['Market','Andijan direction'], 'Shahrixon local-area alias still needs a verified standalone spatial match.'),
