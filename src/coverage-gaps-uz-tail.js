...
export const UZ_TAIL_COVERAGE_GAPS = Object.freeze([
  ...
  ...gaps('Asaka', 'poi', ['UzAuto Motors','Asaka Bank','Dehqon Bazaar'], 'Asaka landmark still needs a verified spatial match.'),
  ...
  ...gaps('Shirin', 'poi', ['Syrdarya TPP','HPP'], 'Shirin landmark still needs a verified spatial match.'),
  ...
  ...gaps('Takhiatash', 'poi', ['Takhiatash TPP','Amu Darya'], 'Takhiatash landmark still needs a verified spatial match.'),
  ...
  ...gaps('Xonobod', 'poi', ['Andijan Reservoir','Xonobod Sanatorium'], 'Xonobod landmark still needs a verified spatial match.'),
].map(Object.freeze));
