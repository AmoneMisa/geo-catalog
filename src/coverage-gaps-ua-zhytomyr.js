...
export const UA_ZHYTOMYR_COVERAGE_GAPS = Object.freeze([
  ...gaps('microdistrict', ['Malikova','Muzykalka'], 'The listing locality is attested in Zhytomyr, but a unique current standalone spatial owner has not yet been independently verified; a same-named street, facility or nearby quarter is intentionally not substituted.'),
