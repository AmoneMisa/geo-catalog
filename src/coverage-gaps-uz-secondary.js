...
export const UZ_SECONDARY_COVERAGE_GAPS = Object.freeze([
  ...
  ...gaps('Shakhrisabz', 'local_area', ['Center','Old City','Oqsaroy','Chorsu','Amir Temur','Kitob direction','Railway Station area'], 'Shakhrisabz local-area alias still needs a verified standalone spatial match.'),
