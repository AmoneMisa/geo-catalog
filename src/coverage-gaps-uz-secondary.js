...
export const UZ_SECONDARY_COVERAGE_GAPS = Object.freeze([
  ...
  ...gaps('Termez', 'poi', ['Old Termez','Hakim at-Termiziy','Amu Darya','Afghanistan Friendship Bridge'], 'Termez landmark still needs a verified spatial match.'),
  ...
  ...gaps('Kokand', 'poi', ['Norbutabiy Madrasa','Kokand Bazaar'], 'Kokand landmark still needs a verified spatial match.'),
