const osmMicrodistrict = (slug, canonicalName, parentId, lat, lng, osmId, accuracyM = 500) => ({
...
export const TASHKENT_CHILANZAR_15_20_ENTITIES = Object.freeze([
  ...
  osmMicrodistrict('chilanzar-20', 'Chilanzar-20', 'uz:tashkent:chilanzar', 41.26648, 69.18072, 1866856600),
]);
