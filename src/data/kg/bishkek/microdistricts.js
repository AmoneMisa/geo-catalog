const microdistrict = (slug, canonicalName, lat, lng, sourceUrl, parentId = 'kg:bishkek') => Object.freeze({
...
export const KG_BISHKEK_MICRODISTRICT_ENTITIES = Object.freeze([
  ...
  microdistrict('4-i-mikroraion', '4-й микрорайон', 42.837756, 74.626347, 'https://2gis.kg/bishkek/geo/15763260120760336', 'kg:bishkek:district:oktyabrsky'),
  microdistrict('5-i-mikroraion', '5-й микрорайон', 42.83199, 74.626102, 'https://2gis.kg/bishkek/geo/15763260120760330', 'kg:bishkek:district:oktyabrsky'),
  ...
  microdistrict('9-i-mikroraion', '9-й микрорайон', 42.835688, 74.604328, 'https://2gis.kg/bishkek/geo/15763260120760334', 'kg:bishkek:district:oktyabrsky'),
