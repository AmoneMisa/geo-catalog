...
export const UA_CHERKASY_COVERAGE_GAPS = Object.freeze([
  ...gaps('microdistrict', ['Lunacharskyi','D','700-richchia'], 'The listing locality is attested, but no independently verified standalone locality center or current map object was established with sufficient confidence in this pass.'),
