...
export const UA_MYKOLAIV_COVERAGE_GAPS = Object.freeze([
  ...gaps('district', ['Tsentralnyi','Zavodskyi','Inhulskyi','Korabelnyi'], 'Administrative district is verified, but an authoritative boundary-derived representative center is not stored; arbitrary neighborhood points are intentionally not substituted.'),
