...
export const UA_POLTAVA_COVERAGE_GAPS = Object.freeze([
  ...
  ...gaps('residential_complex', ['European','Standard','Family Park','Simeinyi','Peliustkovyi','Levada','Dynastiia','Petrivskyi Kvartal','City Park','Victory Club House'], 'The residential complex is attested, but no independently verified representative center for the exact complex was established in this pass.'),
