...
export const UA_VINNYTSIA_COVERAGE_GAPS = Object.freeze([
  ...gaps('microdistrict', ['Slovianska','Barske Shose'], 'The parser name is attested in Vinnytsia usage, but no independently verified standalone locality center/object reference was established in this pass; nearby streets or facilities are intentionally not substituted.'),
  Object.freeze({
  ...
  ...gaps('poi', ['Friendship Park','Roshen Embankment'], 'The landmark is attested, but a unique current representative center/object was not independently verified with enough confidence to store spatially in this pass.'),
]);
