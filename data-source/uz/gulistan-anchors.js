...
export const GULISTAN_SPATIAL_ENTITIES = Object.freeze([
  ...
  osmEntity('poi.market', 'dehqon-bazaar', 'Dehqon Bazaar', 40.47654, 68.77968, 'way', 464281418, 'poi', 120),
  osmEntity('poi.university', 'gulistan-state-university', 'Gulistan State University', 40.50611, 68.78324, 'way', 362811771, 'poi', 160),
  osmEntity('poi.stadium', 'central-stadium', 'Central Stadium', 40.49938, 68.78234, 'way', 1158899453, 'poi', 180),
]);
